...
According to the data, there are about an average of 10 calls a day. 

I notice that October 2022 and Jan 2022 have the most daily calls. I also noticed that the number of calls seems to fluctuate. On the graph, I see that one point is significantly lower, and then the point following it is higher.
...
The data shows that there are 7 unusually low call days and 11 unusually high call days. These days are just the top 95% of the data. However, there is one very unusual z-score (3.39) for 10/04/2022, so on this day there were a very unusually high call count which is only 0.3 % of the normally distributed data.
...
On Saturday, there was the an unusually high number of 911 overdose calls. There was an average of 11.3 calls, which is the greatest number of calls of the week. 
...
- There was an unusually high number of calls on New Years Day. The z-score was greater than 2. A potential story could talk about why more people call to report overdoses on this particular day. Does it relate to New Years Eve and the fact that more people could be drinking or using drugs? 

Next steps and editor:
- I think it would interesting to look at the average monthly overdose call data for December and compare it with the outlier. It might be beneficial to get some data related to the number of DUIS on New Years Day or News Years Eve, as well as data related to alcohol consumption? 
