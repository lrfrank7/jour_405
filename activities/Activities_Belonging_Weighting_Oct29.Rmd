...
1. UMD acknowledged that the survery doesn't necessarily represent the unique experiences of the individual groups that compromises the "Race/Ethnicities with Small Sample Sizes" category. This category is compromised of at least 7 groups, but made up on 2% of the respondents. 

2. According to the survey, 12% of students did not report their race/ethnicity. I wonder why this is the case and if this has any impact on the results and findings. 
#-------------------------------------------------------------------------------
#Survey Weighting
#-------------------------------------------------------------------------------
...
2. What does it mean when a respondent has a weight of 0.23? What about 3.04? ** When a respondent has a weight of 0.23, that means they are underrepresented. When a respondent has a weight of 3.04, that means they are overrepresented

3. Why might some respondents be weighted more heavily than others? ** Some respondents might be weighted more heavily than others because they are less represented in the data, so the weight compensates for the lack of or missing  specific respondents. 
...
1. Which voter category shows the biggest difference between weighted and unweighted results? ** rarely/never category

2. How might these differences affect reporting on likely voter turnout? ** The people who are unlikely to vote are more unlikely to answer the survery and thus would affect the reporting of the likely voter turnout. 

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? ** Those who respond to the survey are more likely to be over-represented in the data compared to those who don't vote or answer the survey.
