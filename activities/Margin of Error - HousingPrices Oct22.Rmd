...
**Write your answers here: I think the headline is a little misleading and not justified. The headline says majority support the new city policy, except this isn't the case for all the sample sizes. When you include the 10% margin of error in the first scenario (52% support, sample size 100,) that means a majority may NOT support the new city policy since it could be -10%. 

An alternative headline: 'Less than Half of Residents Say They Support New City Policy'
...
County Property Records show that home sale prices have increased since the transit line was built. The statistical test found that it was highly probable based on the result being higher than a base test value. Previously the average of the price of a home was $258K, and that average has gone up by about $19,500 since the transit line was built. A possible reason for this increase could be that the transportation has brought more people to the area, and therefore increasing the demand for homes. 