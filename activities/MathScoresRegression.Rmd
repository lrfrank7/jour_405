...
Based on the data, it appears that there is a weak positive correlation between the FARMS % and math test scores. Many of the data points are far from the linear regression. 
...
Answer: This model is not worth using because it shows that the p-value is not significant, the r-square- value is also not significant. Because this is not statistically significant, we cannot find the nature of the relationship between FARMS percentage and math score.  
...
Answer: The largest differences between the predicted and actual math scores are about 35% points below the predicted value (Whitemarsh Elementary School) and about 31% points above the predicted value (Crooked Billet Elementary School). The biggest absolute residual is about 45.82 points.
...
Based on the results of the models, I can't say that there's a relationship between elementary schools with fewer student son free and reduced price meals and performing better on standardized math tests. Because I don't have statistically significant information to prove that claim, I couldn't make an accurate story pitch about that. Therefore, the story could point towards why the board member is making a claim that is not backed by the numbers. 
