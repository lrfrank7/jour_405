...
**Your answer**: Household income data could be skewed because there is a wealth inequality so the data most likely will skew right. Gambling/gaming outcomes could also be skewed because a lot of it is based on luck/random. 

If a reporter is a working on a story about data that isn't normally distributed, they should be transparent with the readers about why the data is the way it is and provide context. For example, for the wealth inequality data, it would be important to explain the outliers in the data, like the small percent of very wealthy people. A reporter can find the median instead of using the mean. 
...
**Answer**: Comapared to the total aces among the other schools in the dataset, Maryland is in the 95th percentile, so only 5% of the values were higher -- three teams were in the 100th percentile. This puts Maryland in a signifcantly good standing compared to the other schools, especially those in the BIG10.
...
**Answer**: The data is skewed to the right. The standard deviation of the mean is around 4.3. Although the mean is around 12.7, there is some variation and the data could fall 4.3 below or above 12.7. 34% of the data points lie within 12.7 +4.3 and 34% of the data points lie within 12.7 - 4.3.
