...
The education levels in survery samples might not be representative of the general population because not everyone has the same liklihood of getting selected for or responding to the survery. Some factors that might cause certain education groups to be over or underrepresentated include socioeconomic status, language barriers, and differences in how people are recruited for the survey. 
...
"College graduates are much more likely to vote than those with high school degree."
...
After applying the weights, the "high school or less" education group showed the biggest changes. Before applying the weights, the "high school or less" group had around 73% that said yes to voting, 14% that said no to voting, and 11% that were unsure. Once the weights were applied, 70% said yes to voting, 16% said no to voting, and 13% were unsure. 

2. Why might the weighted results be considered more accurate than the unweighted results?

Weighted results are considered to be more accurate than unweighted results because they provide a more precise estimate when data has unequal or uneven representation. 
...
Unweighted results can be misleading and may not reflect the true population. Survey weighting can show which groups are under or overrepresented which is important for journalists to understand when reporting on polls. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?

Weighting helped me understand the gap between the college educated and high school educated. I would report on this data by explaining what weighting is and talk about the weighted v. unweighted results. 
...
Some additional information I'd want to know: how much the weight amounts were and which factors were used in the process like the age, or gender of the sampled students.
