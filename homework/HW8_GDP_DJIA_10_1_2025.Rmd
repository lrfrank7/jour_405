...
GDP|> 
  ...
  labs(title="Relationship between two economic indicators", x = "GDP", y = "DJIA")
```
...
There is a positive relationship between the DJIA and GDP. The scatterplot shows that as the values of the GDP increase, so do those of the DJIA. The correlation coefficient of around 0.95 indicates that there is a strong correlation between the two variables. 
